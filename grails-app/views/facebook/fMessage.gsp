    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            <div class="modal-body">
                <h2>Facebook API</h2><g:link controller="API" action="index" class="btn">Home</g:link>
                <hr class="star-primary">
                <br>
                <img src="${imageUrl}"><br>
                <p>
                    Hi ${username} , you have successfully logged in.<br><g:link controller="logout">Logout</g:link>
                </p>
